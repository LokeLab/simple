...
class Typeactivity extends Eloquent  {
	...
	{
		return Typeactivity::whereUpdate(1)->get();
	}
	...
	{
		return Typeactivity::whereUpdate(0)->get();
	}
	...
	{
		return Typeactivity::whereId($id)->first();
	}
	...
	{
		return Typeactivity::find($id)->description;
	}
