    ...
    <li>
     ...
     @if ( Session::has('username') )
        ...
        @if (Auth::user()->role == 1)
          ...
          <li ><a href="{{ url('/survey') }}"><i class="fa fa-bullseye"></i><span class="title"> Schede compilate</span></a></li>
        ...
        @if (Auth::user()->role != 1 && Auth::user()->role == 6)
          <li ><a href="{{ url('/home') }}"><i class="fa fa-home"></i><span class="title">  {{Lang::get('navigation.home');}} </span></a></li>
          <li ><a href="{{ url('/survey/add') }}"><i class="fa fa-plus"></i><span class="title"> Compila una scheda</span></a></li>
          <li ><a href="{{ url('/survey') }}"><i class="fa fa-bullseye"></i><span class="title"> Schede compilate</span></a></li>
