...
<div class="row">
	<div class="col-lg-10">
		<h1>{{Lang::get('typeactivity.addtypeactivity');}}</h1>
	</div>
</div>

{{ Form::open(array('url' => 'typeactivity', 'method' => 'POST')) }}
<div class="row">
	<div class="col-lg-3">
		<div class="form-group">
			{{ Form::submit(Lang::get('generic.save'),  array('class' =>'btn btn-success btn-large')) }}
			&nbsp;
			<a href="{{ url('typeactivity') }}" class="btn btn-warning">{{Lang::get('generic.cancell');}}</a>
		</div>
	</div>
</div>
<!--<div class="row">
