		...
		<div class="portlet box green">
			...
			<div class="portlet-body">
					...
					<div class="row"><div class="col-lg-12"> 
						...
						{{ Form::open(array('url' => '/cost', 'method' => 'GET')) }}
						...
						<tr class="odd gradeX">
							...
							<td align="right">
								 ...
								 if($c->verified) 
								 	...
								 	echo '<a href="/cost/'.$c->id.'/edit " class="btn red">'.trans('budget.rejected').'</a>';
								 else if($c->active) 
							...
							<td>
								...
								{
								?>
								<a href="/cost/{{ $c->id }}/check " class="btn blue">{{Lang::get('generic.view');}}</a>
								<?php } ?>
