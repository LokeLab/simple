...
@endif 
		<div class="center">
			<div class="bottone_wip"><a href="{{ url('/visit/a3/'.$idp.'/'.$id) }}"  ><img src="/images/ESEC_procedi.png" alt="Full quote Unipol" width=385></a><a href="{{ url('/a/'.$idp) }}" ><img src="/images/ESEC_cancella.png" alt="Full quote Unipol"></a>
